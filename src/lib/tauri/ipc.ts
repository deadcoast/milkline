...
export async function removeTrackFromPlaylist(
  ...
  return await invoke<Playlist>("remove_track_from_playlist", {
    playlistId,
    trackId,
  });
}
...
export async function reorderPlaylistTracks(
  ...
  return await invoke<Playlist>("reorder_playlist_tracks", {
    playlistId,
    trackIds,
  });
}
...
export async function loadSkin(
  skinPath: string,
): Promise<import("../types").ParsedSkin> {
...
export async function getSkinAssets(
  skinPath: string,
...
export async function spotifyAuthenticate(
  credentials: SpotifyCredentials,
  authCode: string,
): Promise<SpotifyToken> {
  return await invoke<SpotifyToken>("spotify_authenticate", {
    credentials,
    authCode,
  });
}
 ...
 */
export async function loadSkinSafe(
  skinPath: string,
): Promise<import("../types").ParsedSkin | null> {
  try {
 ...
 */
export async function applySkinSafe(
  skinPath: string,
): Promise<import("../types").ParsedSkin | null> {
  try {
 ...
 */
export async function createPlaylistSafe(
  name: string,
 ...
 */
export async function spotifyAuthenticateSafe(
  credentials: SpotifyCredentials,
  authCode: string,
