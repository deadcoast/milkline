...
describe('SetupWizard', () => {
    ...
    it('should show error for invalid library path', async () => {
        ...
        expect(screen.getByText('Directory does not exist or is not accessible')).toBeTruthy();
    });
    ...
    it('should enable streaming services when checkboxes are checked', async () => {
        ...
        // Enable Spotify
        const spotifyCheckbox = screen.getByLabelText('Enable Spotify integration') as HTMLInputElement;
