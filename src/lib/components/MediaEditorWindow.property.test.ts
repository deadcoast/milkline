                ...
                fc.property(
                    ...
                    fc.string({ minLength: 1, maxLength: 10 })
                        .filter(ext => {
                            ...
                            return !['png', 'jpg', 'jpeg', 'bmp', 'gif', 'mp4', 'mov', 'mkv'].includes(lower);
                        }),
                    fc.string({ minLength: 1, maxLength: 50 }),
                    (extension, filename) => {
                        const filePath = `${filename}.${extension}`;
        ...
        it('should handle case-insensitive extensions', () => {
            fc.assert(
                fc.property(
                    ...
                    fc.constantFrom('png', 'jpg', 'jpeg', 'bmp', 'gif', 'mp4', 'mov', 'mkv'),
                    fc.string({ minLength: 1, maxLength: 50 }),
                    (extension, filename) => {
            ...
            fc.assert(
                fc.property(
                    ...
                    (extension, directories, filename) => {
                        ...
                        const filePath = directories.join('/') + '/' + filename + '.' + extension;
                        const mediaType = getMediaTypeFromExtension(filePath);
