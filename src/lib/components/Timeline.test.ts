...
describe('Timeline Component - Unit Tests', () => {
    ...
    it('should update start time when dragging start handle', async () => {
        ...
        const startHandle = container.querySelector('.timeline-handle-start') as HTMLElement;
    ...
    it('should update end time when dragging end handle', async () => {
        ...
        const endHandle = container.querySelector('.timeline-handle-end') as HTMLElement;
    ...
    it('should constrain start handle to not exceed end handle', async () => {
        ...
        const mockRect = { left: 0, top: 0, width: 400, height: 40, right: 400, bottom: 40 };
    ...
    it('should render selection region between handles', () => {
        ...
        const selection = container.querySelector('.timeline-selection') as HTMLElement;
        ...
        await fc.assert(
            fc.asyncProperty(
                ...
                async ({ duration, startTime, endTime, dragStartX, dragEndX }) => {
                    ...
                    const validEndTime = Math.max(validStartTime, Math.min(endTime, duration));
